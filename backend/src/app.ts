...
import { activityArticlesRouter } from "./routes/activity-articles.route.js";
import { alertsRouter } from "./routes/alerts.route.js";
import { btpProjectsRouter } from "./routes/btp-projects.route.js";
...
import { generalStoreShopsRouter } from "./routes/general-store-shops.route.js";
...
app.use(env.API_PREFIX, generalStoreShopsRouter);
app.use(env.API_PREFIX, btpProjectsRouter);
